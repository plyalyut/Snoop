				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>Snoop: Kennels</strong></a>
									<ul class="icons">
							...
							<!-- Content -->
								<section>
									...
									<span class="image main"><img src="images/pup.jpg" alt="" /></span>
									...
									<!-- Form -->
										...
										<form method="get" action="kennel.php">
											<div class="row uniform">
												...
												<!-- Break -->
												<div class="12u$">
													<textarea name="demo-message" id="demo-message" placeholder="List the Dog Breeds" rows="6"></textarea>
												</div>
												<!-- Break -->
												<div class="12u$">
													<ul class="actions">
							...
							<!-- Menu -->
								<nav id="menu">
									...
									<ul>
										...
										<li><a href="kennelowners.html">Kennel Owners</a></li>
										<li>
